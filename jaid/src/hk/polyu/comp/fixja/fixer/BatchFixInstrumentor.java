...
import static hk.polyu.comp.fixja.util.FileUtil.FQClassNameToRelativeSourcePath;
...
public class BatchFixInstrumentor {
    ...
    public static final int TOTAL_BATCH_SIZE = BatchFixInstrumentor.BATCH_SIZE * BatchFixInstrumentor.BATCH_SIZE;
    ...
    private String getDispatcher(int dispatcherID){
        ...
        sb.append("\tswitch(").append(Tester.class.getName()).append(".").append(Tester.GET_INDEX_INSIDE_BATCH_METHOD_NAME).append("()){\n");
        int startIndex = dispatcherID * BatchFixInstrumentor.BATCH_SIZE;
        int endIndex = startIndex + BatchFixInstrumentor.BATCH_SIZE;
    ...
    private String getOriginalMethod(){
        ...
        // Dispatching calls
        sb.append("\tswitch(").append(Tester.class.getName()).append(".").append(Tester.GET_BATCH_INDEX_METHOD_NAME).append("()){\n");
        String methodInvocation = null;
        int nbrFixActions = fixActions.size();
        for(int i = 0; i * BatchFixInstrumentor.BATCH_SIZE < nbrFixActions; i++){
    ...
    private String classWithInstrumentation(){
        ...
        for(int i = 0; i < BatchFixInstrumentor.BATCH_SIZE && i * BatchFixInstrumentor.BATCH_SIZE <= fixActions.size(); i++){
