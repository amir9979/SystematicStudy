...
public class FixerOutput {
    ...
    public static Path getFixLogFilePath(int fixId) {
        return rootDir.resolve(TEMP_FIX_DIR_PRE_NAME).resolve(TEMP_FIX_DIR_PRE_NAME + fixId + OBSERVED_Fix_LOG_FILE_NAME);
    }
    ...
    private static final String ROOT_DIR_NAME = "fixja_output";
