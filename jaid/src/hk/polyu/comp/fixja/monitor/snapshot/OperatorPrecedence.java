...
public class OperatorPrecedence {
    ...
    public static boolean hasOperatorGreaterPrecedence(Operator operator, Expression expression){
        return getOperatorPrecedence(operator) > getExpressionPrecedence(expression);
    }

    public static boolean hasOperatorGreaterEqualPrecedence(Operator operator, Expression expression){
        return getOperatorPrecedence(operator) >= getExpressionPrecedence(expression);
    }

    public static boolean hasOperatorGreaterPrecedence(PrefixExpression.Operator operator, Expression expression){
        return PREFIX > getExpressionPrecedence(expression);
    }

    public static boolean hasOperatorGreaterEqualPrecedence(PrefixExpression.Operator operator, Expression expression){
        return PREFIX >= getExpressionPrecedence(expression);
    }
