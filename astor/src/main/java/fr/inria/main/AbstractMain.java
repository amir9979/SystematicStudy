...
public abstract class AbstractMain {
	...
	static {
		...
		options.addOption("suspiciousCodeFile", true,
				"The file contains all suspicious code.");
	...
	public boolean processArguments(String[] args) throws Exception {
		...
		if (cmd.hasOption("suspiciousCodeFile")) {
			ConfigurationProperties.properties.setProperty("suspiciousCodeFile", cmd.getOptionValue("suspiciousCodeFile"));
