...
//				this.suspiciousValue = Double.valueOf(metric.value(efn, epn, nfn, npn) / 4 * suspiciousWeight);
//				return;
//			}
//		}
//		this.suspiciousValue = Double.valueOf(metric.value(efn, epn, nfn, npn) * suspiciousWeight);
