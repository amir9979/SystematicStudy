...
//				subloc_title = subloc_items[0];
	...
	private static class NodeFindVisitor extends ASTVisitor {
		...
		public NodeFindVisitor(int charseq) {
		...
		public boolean preVisit2(ASTNode node) {
			...
			// ========
			/*
			 * System.err.println("--- Node ---"); CompilationUnit cu = (CompilationUnit)
			 * node.getRoot(); System.err.println("QUERY CHARSEQ: " + charseq);
			 * System.err.println("CURRENT CHARSEQ: " + node_charseq);
			 * System.err.print("CURRENT LC: ");
			 * System.err.println(cu.getLineNumber(node_charseq)+","+cu.getColumnNumber(
			 * node_charseq)); System.err.println(node); System.err.println();
			 */
			// ========
