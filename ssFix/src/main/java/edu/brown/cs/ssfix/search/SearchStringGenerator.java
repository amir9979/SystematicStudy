...
public class SearchStringGenerator {
	...
	public String getBugOnlySearchString(File f, String buggy_stmt_loc, String search_strategy, String output_dpath) {
		...
		String rslt = getSearchString(ANAL_METHOD0, "\"" + bugonly_chunk_loc + "\"", search_strategy, fpath,
				output_dpath + "/bugonly_" + search_strategy);
		return rslt;
	}
	...
	public String getLocalContextSearchString(File f, String buggy_stmt_loc, String search_strategy,
			String output_dpath) {
		...
		String rslt = getSearchString(ANAL_METHOD0, "\"" + lctxt_chunk_loc + "\"", search_strategy, fpath,
				output_dpath + "/lctxt_" + search_strategy);
