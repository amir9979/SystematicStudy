...
public class ModificationSizeCalculator {
	...
	public static float calculate1(Object obj1, Object obj2, int size_type) {
		if (obj1 == null && obj2 == null) {
			...
			return (size_type == HEIGHT_SIZE) ? calculateHeightSize(obj2)
					: calculateStringSimilarity("", obj2.toString());
		} else if (obj1 != null && obj2 == null) {
			return (size_type == HEIGHT_SIZE) ? calculateHeightSize(obj1)
					: calculateStringSimilarity(obj1.toString(), "");
		} else {
			if (size_type == HEIGHT_SIZE) {
	...
	public static float calculate2(@SuppressWarnings("rawtypes") List list1, @SuppressWarnings("rawtypes") List list2, int size_type) {
	...
	private static float calculateHeightSize(@SuppressWarnings("rawtypes") List list) {
		if (list == null) {
			return 0;
		}
		int height_size = 0;
