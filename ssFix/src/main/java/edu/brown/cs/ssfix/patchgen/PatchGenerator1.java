...
public class PatchGenerator1 {
	...
	public List<Modification> generatePatches(BuggyChunk bchunk, CandidateChunk rcchunk, boolean print_ccmatching,
			boolean print_patches) {
