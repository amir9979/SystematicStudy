...
public class CandidateLoader {
	...
	public static String getFileContent(String cfpath, String anal_method) {
		...
		// ====================
		/*
		 * System.out.println("*** Cocker Search Arguments ***"); for (String cocker_arg
		 * : cocker_args) { System.out.print(cocker_arg+" "); } System.out.println();
		 * System.out.println();
		 */
		// ====================
		...
		try {
			search_rslt0 = future.get(3l, TimeUnit.MINUTES);
		} catch (Exception e) {
